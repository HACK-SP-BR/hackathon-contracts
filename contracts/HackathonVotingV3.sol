...
contract HackathonVotingV3 {
    ...
    function addProject(
        ...
        emit ProjectAdded(hackathonId, h.projectCount, creator, name);
    }
    ...
    function getProjectCreator(
        uint256 hackathonId,
        uint256 projectId
    ) external view hackathonExists(hackathonId) returns (address) {
    ...
    function vote(
        ...
        require(p.exists, "Invalid project");
        require(msg.sender != p.creator, "Project creator cannot self-vote");
